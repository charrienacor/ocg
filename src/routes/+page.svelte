...
<div class="relative flex justify-center">
  ...
  <div class="static z-50 ml-10 mt-28">
    <h1 style="text-align:left; font-weight: 900; font-size: 60px; margin-top: 20px; margin-bottom:0px; line-height:80px; background: -webkit-linear-gradient(#8e1537, #00573f); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
      UPB OCG PATNUBAY 
      <br />
      <span style="font-size: 65px; margin-top: 0px; padding-top: 0px; line-height:0px; background: -webkit-linear-gradient(#8e1537, #00573f); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">AGUHON</span>
    </h1>
    <div class="static z-50">
      <div class="w-4/6 sm:w-6/12">
        <p style="font-size: 18px; line-height: 28px; color: rgb(55 65 81); padding: 10px 0px 30px 0px;">
