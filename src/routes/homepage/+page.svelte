...
<div class="relative overflow-x-hidden sm:mt-20">
  <div class="center relative top-1/2 flex flex-col gap-3 rounded-lg bg-white px-8 py-8">
    ...
    <div class="flex flex-col justify-center gap-3 lg:flex-row">
      ...
      <Button href="/login-student" variant="bigbutton" size="large">
        ...
        <p class="text-wrap text-balance text-center md:text-nowrap">To fill out Backgorund Information Sheet (BIS) or avail free services</p>
      </Button>
    </div>
  </div>
</div>