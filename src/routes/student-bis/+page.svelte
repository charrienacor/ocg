...
<body class="relative mb-10 mt-5">
  <h1 class="font-bold">BACKGROUND INFORMATION SHEET</h1>
  <form method="POST" use:enhance>
    <div
      class="center relative top-1/2 mt-10 flex flex-col gap-3 rounded-lg bg-white px-8 py-8"
    >
      <h1>Preliminaries</h1>
    ...
    >
      ...
      <Form.Field {form} name="Reading">
        <Form.Control let:attrs>
          <Form.Label
            >Do you like reading? (If yes, what do you like reading?)</Form.Label
          >
    ...
    <div
      class="center relative top-1/2 mb-10 mt-10 flex flex-col gap-3 rounded-lg bg-white px-8 py-8"
    >
      <h1>Closing Question</h1>
      <p>
        On the space below, write about your dreams and aspirations in life,
        your expectations of UP Baguio, and your objectives for studying in UPB.
      </p>
