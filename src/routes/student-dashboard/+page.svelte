...
<div class="threedots absolute right-10 top-10">
  ...
  <div id="dropdownDots" class="z-10 hidden w-44 right-10 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700">
...
<div class="center relative top-1/2 mt-16 flex flex-col gap-3 rounded-l bg-white px-8 py-8 md:mt-20">
  ...
  <div class="relative flex flex-col justify-center gap-3 sm:flex-row">
    <Button
      variant="bigbutton"
      size="large"
      on:click={() => goto("/student-bis")}>
      <AlignLeft size={100} />
      <p class="text-wrap text-xl">
        Fill up the Background Information Sheet (BIS)
      </p>
    </Button>
    <Button
      variant="bigbutton"
      ...
      <p class="text-wrap text-xl">
        Schedule an Appointment <br />(Free Consultations)
      </p>
    </Button>
  </div>
  <Button
