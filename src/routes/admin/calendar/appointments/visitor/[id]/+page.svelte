<script lang="ts">
  ...
  <h1 class="pt-12 pb-4 font-bold sm:pt-5">Visitor Appointment</h1>
    ...
    <Card.Root>
      ...
      <Card.Content>
        ...
        <div class="flex">
          ...
          <p class="leading-5" style="padding-left: 63px;">{appointment.Visitor_Name}</p>
        </div>
        <div class="flex">
          <Card.Title>Visitor Email: </Card.Title>
          <p class="leading-5" style="padding-left: 67px;">{appointment.Visitor_Email}</p>
        </div>
        <div class="flex">
          <Card.Title>Contact Number: </Card.Title>
          <p class="leading-5" style="padding-left: 34px;">{appointment.Contact_Num}</p>
        </div>
        <div class="flex">
            <Card.Title>Affiliated Institution: </Card.Title>
            <p class="leading-5" style="padding-left: 13px;">{appointment.Visitor_Institution}</p>
          </div>
        <div class="flex">
