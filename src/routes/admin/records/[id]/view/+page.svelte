...
<div class="relative mb-10 mt-5">
  <div class="flow-root">
    <h1 class="float-left pb-0 pt-12 font-bold sm:pt-5">
      RECORDS OF [STUDENT'S FIRST NAME]
    </h1>
  ...
  <form method="POST" use:enhance>
    <div class="flex flex-row gap-2">
      <div
        class="center relative top-1/2 mt-4 flex w-1/2 flex-col gap-3 rounded-lg border bg-white px-8 py-8 sm:mt-10"
      >
        <h1>1 x 1 ID Picture</h1>
        <p class="flex h-60 justify-center">Insert Image Here</p>
      </div>
      <div
        class="center relative top-1/2 mt-4 flex w-1/2 flex-col gap-3 rounded-lg border bg-white px-8 py-8 sm:mt-10"
      >
    ...
    <div
      class="center relative top-1/2 mt-4 flex flex-col gap-3 rounded-lg border bg-white px-8 py-8 sm:mt-10"
    >
      <h1>UPCAT Grades</h1>
      ...
      <div class="text-center md:grid md:grid-cols-6 md:gap-3">
        <Form.Field {form} name="Sci">
          <Form.Control let:attrs>
            ...
            <Input {...attrs} placeholder="XXX" bind:value={$formData.Sci} />
          </Form.Control>
          <Form.FieldErrors />
        </Form.Field>
        ...
        <Form.Field {form} name="Math">
          <Form.Control let:attrs>
            <Form.Label
              ><p style="line-height: 42px;">Mathematics</p></Form.Label
            >
            <Input {...attrs} placeholder="XXX" bind:value={$formData.Math} />
          </Form.Control>
          <Form.FieldErrors />
        </Form.Field>
        ...
        <Form.Field {form} name="X">
          <Form.Control let:attrs>
            ...
            <Input {...attrs} placeholder="XXX" bind:value={$formData.X} />
          </Form.Control>
        </Form.Field>
        ...
        <Form.Field {form} name="UPG">
          <Form.Control let:attrs>
            <Form.Label
              ><p style="line-height: 42px;">Total UP Grade</p></Form.Label
            >
            <Input {...attrs} placeholder="XXX" bind:value={$formData.UPG} />
          </Form.Control>
          <Form.FieldErrors />
        </Form.Field>
      </div>
      ...
      <div class="gap-4 md:grid md:grid-cols-2">
        ...
        <Form.Field {form} name="Age">
          <Form.Control let:attrs>
            ...
            <Input {...attrs} placeholder="Age" bind:value={$formData.Age} />
          </Form.Control>
          <Form.FieldErrors />
        </Form.Field>
