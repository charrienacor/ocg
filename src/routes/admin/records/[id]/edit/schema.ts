...
export const formSchema = z.object({
  ...
  Place_Of_Birth: z.string().max(100),
  ...
  Cellphone_Number: z.string().max(11),

  Email_Address: z.string(),

  Baguio_Address: z.string().max(100),

  Baguio_Telephone_Number: z.string().max(30),

  Permanent_Address: z.string(),

  Permanent_Telephone_Number: z.string().max(30),

  // Family Data

  Parent_Status: z.string(),

  Guardian: z.string().max(50),

  Guardian_Address: z.string().max(100),

  Guardian_Telephone_Number: z.string().max(30),
  ...
  Source_Of_Income: z.string(),

  Other_Sources: z.string(),

  Allowance: z.string(),

  Source_Of_Allowance: z.string(),

  Specifics: z.string(),

  Second_Other_Sources: z.string(),
  ...
  Second_No_Reasons: z.string(),

  Second_Other_Sources_V: z.string(),
